...
class TestProfileArea:
    ...
    def test_transition_to_personal_area_from_main_page(self, driver, get_login_driver):
    ...
    def test_transition_from_personal_area_to_constructor_by_click_constructor_btn(self, driver, get_login_driver):
    ...
    def test_transition_from_personal_area_to_constructor_by_click_logo(self, driver, get_login_driver):
