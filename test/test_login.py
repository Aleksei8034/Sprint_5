...
class TestLogin:
    ...
    def test_login_in_login_btn(self, driver):
    ...
    #Вход по кнопке 'Личный кабинет' на главной странице
    def test_login_in_personal_account_btn(self, driver):
    ...
    def test_login_in_recover_form(self, driver):
